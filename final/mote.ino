...
// Sink MAC address
uint8_t sinkAddress[6] = {0xEC, 0x62, 0x60, 0x5B, 0x35, 0x08};

// All motes MAC addresses
uint8_t moteAddress[MOTE_COUNT][6] = {
  {0x24, 0xDC, 0xC3, 0x14, 0x38, 0x24},  // Mote 0
  {0x08, 0xF9, 0xE0, 0x00, 0xE2, 0x60},  // Mote 1
  {0x08, 0xF9, 0xE0, 0x01, 0x00, 0x00}   // Mote 2
};
...
routing_entry myRoute = {
  .destMAC = {0xEC, 0x62, 0x60, 0x5B, 0x35, 0x08},      // SINK
  .nextHopMAC = {0xEC, 0x62, 0x60, 0x5B, 0x35, 0x08},   // Direct to SINK
  .hopCount = 1
};
